...
import (
	...
	"github.com/ranecsutu/bookings/internal/config"
	"github.com/ranecsutu/bookings/internal/driver"
	"github.com/ranecsutu/bookings/internal/forms"
	"github.com/ranecsutu/bookings/internal/helpers"
	"github.com/ranecsutu/bookings/internal/models"
	"github.com/ranecsutu/bookings/internal/render"
	"github.com/ranecsutu/bookings/internal/repository"
	"github.com/ranecsutu/bookings/internal/repository/dbrepo"
)
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	htmlMessage := fmt.Sprintf(`
		...
		Dear %s: <br>
		This is confirm your resevation from %s to %s.
	`, reservation.FirstName, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"))

	msg := models.MailData{
		To:      reservation.Email,
		From:    "dsad@dsa",
		Subject: "Reseration Confirmation",
		Content: htmlMessage,
	}
...
// AdminAllReservations shows all reservatrions in admin tool
...
// AdminNewReservations shows all new reservatrions in admin tool
