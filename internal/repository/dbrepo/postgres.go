...
// SearchAvailabilityByDatesByRoomID returns true if availability for roomID exists, false otherwise
...
// UpdateUser authenticates an user
...
// AllRooms returns slice of all rooms
